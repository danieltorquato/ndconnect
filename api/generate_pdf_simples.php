...
function generateOrcamentoHTML($orcamento) {
    ...
    $datasEvento = [];
    if (isset($orcamento['data_evento'])) {
        $datasJson = $orcamento['data_evento'];
        if (is_string($datasJson)) {
            $datasArray = json_decode($datasJson, true);
            if (is_array($datasArray)) {
    ...
    $nomeEvento = isset($orcamento['nome_evento']) ? $orcamento['nome_evento'] : 'Evento';

    // Usar nome da empresa se disponível, senão usar nome do cliente
                    ...
                    <div class="cliente-info">
                        <div class="info-row">
                            <div class="info-cell">
                                ...
                                <span class="info-value">' . htmlspecialchars($nomeExibicao) . '</span>
                            </div>
                            <div class="info-cell">
                        ...
                        <div class="info-row">
                            <div class="info-cell">
                                <span class="info-label">Nome do Evento:</span><br>
                                <span class="info-value">' . htmlspecialchars($nomeEvento) . '</span>
                            </div>
                            <div class="info-cell">
                                <span class="info-label">Data do Evento:</span><br>
                                <span class="info-value">' . $dataEventoFormatada . '</span>
                            </div>
                        </div>
                    </div>
                </div>
