<?php
// Teste do PDF com TCPDF funcional
...
try {
    ...
    $pdf->SetTitle('Orçamento N.D Connect - 12345');
    ...
    $pdfContent = $pdf->Output('orcamento_teste.pdf', 'S');

    // Headers finais
    header('Content-Type: application/pdf');
    header('Content-Disposition: attachment; filename="orcamento_teste.pdf"');
