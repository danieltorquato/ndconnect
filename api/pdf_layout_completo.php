<?php
// Layout completo do PDF com cores e formatação da N.D Connect
...
try {
    ...
    $pdfContent = $pdf->Output('orcamento_ndconnect.pdf', 'S');

    // Headers finais
    header('Content-Type: application/pdf');
    header('Content-Disposition: attachment; filename="orcamento_ndconnect.pdf"');
